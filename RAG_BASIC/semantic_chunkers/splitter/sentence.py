...
from RAG_BASIC.semantic_chunkers.splitter.base import BaseSplitter
...
class RegexSplitter(BaseSplitter):
    ...
    regex_pattern = r"""
        ...
        (?<!\b[A-Z][a-z]\.)
        # Negative lookbehind for abbreviations like "EE.UU."
        (?<!\b[A-Z]\.)
        (?<!\b[A-Z]{2,}\.)  # Handles abbreviations like "EE.UU."
